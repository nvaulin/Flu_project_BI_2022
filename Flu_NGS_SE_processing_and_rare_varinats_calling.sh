...
do  
    ...
    bwa mem -t 14 ${reference} $f 2>> ${WorkDir}/alignment_flu_messages.log | samtools view -Sb -@ 13 - | samtools sort -@ 13 - \
    > ${AlDir}/alignment_${sample}_sorted.bam
   ...
   awk 'BEGIN{FS=OFS="\t"}{gsub(":","\t",$10)}1' ${VarDir}/influenza_${sample}_rare_variants_flu_minfreq1.vcf | awk 'NR>24 {print $2, $4, $5, $16}' \
   > ${VarDir}/variants_list_${sample}.txt
